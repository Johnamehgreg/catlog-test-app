    ...
    <>
      ...
      >
        ...
        <HStack style={{ gap: s(12) }} className="items-center">
          <TouchableOpacity style={{ position: 'relative' }} className='p-3 rounded-full bg-white dark:bg-gray-800'>
            <Bell size={s(20)} color={isDark ? '#FFFFFF' : '#000000'} strokeWidth={2} />
            <View style={styles.badge}>
              <Text style={styles.badgeText}>4</Text>
            </View>
          </TouchableOpacity>

          <TouchableOpacity className='p-3 rounded-full bg-white dark:bg-gray-800' onPress={() => setShowMenuSheet(true)}>
            <Menu size={s(20)} color={isDark ? '#FFFFFF' : '#000000'} strokeWidth={2} />
          </TouchableOpacity>
        </HStack>
      </HStack>

      {/* Menu Action Sheet */}
      <ActionSheetComponent open={showMenuSheet} close={() => setShowMenuSheet(false)}>
        <Box style={{ paddingHorizontal: s(20), paddingVertical: s(20) }}>
          ...
          >
            <HStack style={{ gap: s(12) }} className="items-center">
              {isDark ? (
                <Sun size={s(24)} color={isDark ? '#FFFFFF' : '#000000'} strokeWidth={2} />
              ) : (
                <Moon size={s(24)} color={isDark ? '#FFFFFF' : '#000000'} strokeWidth={2} />
              )}
              <Text
                className='default-text'
                style={[
