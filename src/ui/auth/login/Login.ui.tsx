...
const LoginUi = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Image
          source={require('@assets/pngs/login.png')}
        ...
        <Text
          ...
          style={[
            textStyles.textXl,
            { fontFamily: mediumFontFamily, marginTop: s(10) },
          ]}
        >
          Welcome back,
        </Text>
      ...
      >
        ...
        >
          <Pressable>
            <Text className="primary-text" style={[styles.forgotPassword]}>
              Forgot password?
            </Text>
          </Pressable>
        </View>
