...
const inputStyle = tva({
  base: 'border-background-300 dark:border-outline-700 flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 dark:data-[hover=true]:border-outline-600 data-[focus=true]:border-primary-0 dark:data-[focus=true]:border-primary-0 data-[focus=true]:hover:border-primary-0 dark:data-[focus=true]:hover:border-primary-0 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300 dark:data-[disabled=true]:hover:border-outline-700 items-center',
